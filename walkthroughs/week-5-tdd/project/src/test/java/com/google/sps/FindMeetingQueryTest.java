...
public final class FindMeetingQueryTest {
  ...
  public void optionalAttendeeCannotAttend() {
    // Have no available time slots with the optional attendee, so only time slots for the 
  ...
  public void notEnoughRoomForOptionalAttendee() {
    // Have optional attendee unable to attend because the open time slot is too small
    //
    // Events  : |--A--|       |----A----|
    //                 |-B-|
    // Day     : |-----------------------|
  ...
  public void onlyOptionalAttendeesWithGaps() {
    // Have 2 optional attendees with several gaps in their schedules
    //
    // Events  :      |--A--|          |--A--|
    //                           |--B--|
    // Day     : |---------------------------|
  ...
  public void onlyOptionalAttendeesWithNoGaps() {
    // Have 2 optional attendees with no gaps in their schedules, so no time is available
    //
    // Events  :      |--A--|      |---A---|
    //           |--B-|     |----B----|
    // Day     : |-------------------------|
    ...
    Collection<Event> events = Arrays.asList(
        ...
        new Event("Event 2", TimeRange.fromStartDuration(TIME_1000AM, DURATION_30_MINUTES),
            Arrays.asList(PERSON_A)),
        new Event("Event 3", TimeRange.fromStartEnd(TIME_1030AM, TIME_1130AM, false),
            Arrays.asList(PERSON_B)),
  ...
  @Test
  public void onlyOptionalAttendeesWithNotEnoughRoom() {
    // Have 2 optional attendees with not enough room in their schedules, so no time is available
    //
    // Events  :             |--A--|   |---A---|
    //           |---B---|         |--B---|
    // Day     : |-----------------------------|
    ...
    Collection<Event> events = Arrays.asList(
        ...
        new Event("Event 2", TimeRange.fromStartDuration(TIME_0900AM, DURATION_60_MINUTES),
            Arrays.asList(PERSON_A)),
        new Event("Event 3", TimeRange.fromStartEnd(TIME_1000AM, TIME_1130AM, false),
            Arrays.asList(PERSON_B)),
        new Event("Event 4", TimeRange.fromStartEnd(TIME_1100AM, TimeRange.END_OF_DAY, true),
            Arrays.asList(PERSON_A)));

    MeetingRequest request = new MeetingRequest(Arrays.asList(), DURATION_90_MINUTES);
  ...
  @Test 
  public void mandatoryAndOptionalWithNoRoom() {
    // Have 1 mandatory and 1 optional have not enough room
    //
    // Events  : |--A---|      |---A----|
    //                      |--B--|
    // Day     : |----------------------|
  ...
  @Test
  public void attendeesHaveSameEvents() {
    // Have 1 mandatory and 1 optional registered to attend events at the same time.
    //
    // Events  :       |--A--|  |--A--|
    //                 |--B--|  |--B--|
    // Day     : |--------------------------|
